...
public class ActivityRewardRule extends FragmentActivity {

    private String TAG = ActivityRewardRule.class.getSimpleName();
    ...
    private void setInitView() {
        ...
        mWebView.loadUrl(getString(R.string.reward_rule));
    }
